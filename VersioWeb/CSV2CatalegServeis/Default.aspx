        ...
        <div style="height: 83px; width: 545px; margin-left: 159px; margin-top: 30px; background-color: #CCCCCC; font-family: Arial, Helvetica, sans-serif; font-weight: bold; font-style: normal; font-variant: small-caps;">
                ...
                <tr>
                    <td class="style1">
                        &nbsp;</td>
                    <td class="style2">
                        Login del PAS/PDI</td>
                    <td>
                        <asp:TextBox ID="DNIUsuari" runat="server"></asp:TextBox>
                               </td>
                </tr>
                <tr>
                    <td class="style1">
                        &nbsp;</td>
                    <td class="style2">
                        Valor Grup (UdL_nnnn)</td>
                    <td>
                        <asp:TextBox ID="UDLGrup" runat="server">UdL_nnnn</asp:TextBox>
                               </td>
                </tr>
            </table>
            <div style="height: 70px; margin-top: 25px; text-align: center; vertical-align: text-bottom; background-color: #C0C0C0; font-family: Arial, Helvetica, sans-serif; font-style: normal; font-variant: small-caps; font-weight: bold;">
                Podeu modificar l&#39;atribut fent click aquí&nbsp;&nbsp;&nbsp;&nbsp;
                  <asp:Button ID="btUpdateLDAP" runat="server" Text="Validar dades" 
                    onclick="PostejaForm" />
                       </div>
